...
public final class ViewlrcKLOK extends View implements Runnable {
	...
	private String lrc_content="testing"; //歌词内容
...
//文字自动换行
		StaticLayout layout = new StaticLayout(lrc, textPaint, rect.width(), Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F,true);
		StaticLayout layout1 = new StaticLayout(lrc_1, textPaint, rect.width(), Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F,true);
		canvas.save();
...
*/
		...
		*/
	    ...
	    lrc_backCanvas.drawText(lrc_content, 0, 32, paint);
	    lrc_backNextCanvas.drawText(lrc_1, 0, 32, paint);

		paint.setColor(Color.RED);
		lrc_Canvas.drawText(lrc_content, 0, 32, paint);
		lrc_Canvas1.drawText(lrc_1, 0, 32, paint);
